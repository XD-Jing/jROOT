...
def process():
    h = dict()
    fin = root_open(f'ggZZ-rel75.root', 'r')

    rebin_GGH = [(1, 6), (21, 22), (23, 24), (25, 26), (27, 28), (29, 32), (33, 36), (37, 61)]
    ...
    plot_atlas_logo(ax, loc=[0.05, 0.90], lumi=139, info=f'Scale uncertainty ggZZ-rel75', gap=0.15)
    plt.tight_layout()
    plt.savefig('ggZZ-rel75_GGH_mTZZ_QCD.pdf')
    ...
    plot_atlas_logo(ax, loc=[0.05, 0.90], lumi=139, info=f'PDF uncertainty ggZZ-rel75', gap=0.15)
    plt.tight_layout()
    plt.savefig('ggZZ-rel75_GGH_mTZZ_PDF.pdf')
    ...
    ax.legend(frameon=False)
    plot_atlas_axis(ax, xlabel='', ylabel='Event Fractions', xlim = (100, 1700), ylim=(0, 0.6))
    plot_atlas_axis(axr, xlabel=r'$m_{T}^{ZZ}$[GeV]', ylabel='QCD/NOMINAL', ylim = (0.8, 1.2), yticker = (0.2, 0.05), xlim = (100, 1700))
    plot_atlas_logo(ax, loc=[0.05, 0.90], lumi=139, info=f'Scale uncertainty ggZZ-rel75', gap=0.15)
    plt.tight_layout()
    plt.savefig('ggZZ-rel75_VBF_mTZZ_QCD.pdf')
    ...
    ax.legend(frameon=False)
    plot_atlas_axis(ax, xlabel='', ylabel='Event Fractions', xlim = (100, 1700), ylim = (0, 0.6))
    plot_atlas_axis(axr, xlabel=r'$m_{T}^{ZZ}$[GeV]', ylabel='PDF/NOMINAL', ylim = (0.8, 1.2), yticker = (0.2, 0.05), xlim = (100, 1700))
    plot_atlas_logo(ax, loc=[0.05, 0.90], lumi=139, info=f'PDF uncertainty ggZZ-rel75', gap=0.15)
    plt.tight_layout()
    plt.savefig('ggZZ-rel75_VBF_mTZZ_PDF.pdf')


    fout = root_open(f'ggZZ-rel75-input.root', 'recreate')

    h['GGH- NORM-input'] = hinit(fin, 'llvv__GGH__mTZZ__PFLOW', [(21, 22), (23, 24), (25, 26), (27, 28), (29, 32), (33, 36), (37, 40), (41, 44), (45, 48), (49, 61)])
    h['GGH-QCDUP-input'] = hinit(fin, 'llvv__GGH__mTZZ__QCD12', [(21, 22), (23, 24), (25, 26), (27, 28), (29, 32), (33, 36), (37, 40), (41, 44), (45, 48), (49, 61)])
    h['GGH-QCDDN-input'] = hinit(fin, 'llvv__GGH__mTZZ__QCD15', [(21, 22), (23, 24), (25, 26), (27, 28), (29, 32), (33, 36), (37, 40), (41, 44), (45, 48), (49, 61)])
    h['GGH- NORM-input'].Scale(1./h['GGH- NORM-input'].integral(0, -1))
    h['GGH-QCDUP-input'].Scale(1./h['GGH-QCDUP-input'].integral(0, -1))
    h['GGH-QCDDN-input'].Scale(1./h['GGH-QCDDN-input'].integral(0, -1))
    ...
    fout.cd()
    h['GGH- NORM-input'].Write('ggZZ_rel75_GGH_NORM')
    h['GGH-PDFUP-input'].Write('ggZZ_rel75_GGH_PDFUP_shape')
    h['GGH-PDFDN-input'].Write('ggZZ_rel75_GGH_PDFDN_shape')
    h['GGH-QCDUP-input'].Write('ggZZ_rel75_GGH_QCDUP_shape')
    h['GGH-QCDDN-input'].Write('ggZZ_rel75_GGH_QCDDN_shape')

    h['VBF- NORM-input'].Write('ggZZ_rel75_VBF_NORM')
    h['VBF-PDFUP-input'].Write('ggZZ_rel75_VBF_PDFUP_shape')
    h['VBF-PDFDN-input'].Write('ggZZ_rel75_VBF_PDFDN_shape')
    h['VBF-QCDUP-input'].Write('ggZZ_rel75_VBF_QCDUP_shape')
    h['VBF-QCDDN-input'].Write('ggZZ_rel75_VBF_QCDDN_shape')
