...
jSYST::jSYST(std::string treename, std::string outfile, std::string outopt)
...
bool jSYST::LoopROOT(std::string filename, float xsec){
...
bool jSYST::mkHist(std::string hname, const int nBins, const float left, const float right){
