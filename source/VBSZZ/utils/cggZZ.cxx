...
void read_TREE(std::string treename){
    C_factor t(treename, "/atlas/data19/liji/jROOT/source/VBSZZ/share/cggZZ.343233.root");
...
int main(int argc, const char *argv[]){
    ...
    TFile *f = new TFile("/atlas/data19/liji/jROOT/source/VBSZZ/share/cggZZ.343233.root", "r");
