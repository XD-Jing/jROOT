#ifndef HZZ_LM_emuROOT_h
#define HZZ_LM_emuROOT_h
...
class LM_emuROOT{
    ...
    public :
        LM_emuROOT(std::string treename, std::string outfile = "out.root", std::string outopt = "update", std::string tag = "emuCR");
        virtual ~LM_emuROOT();
        virtual void Close();
