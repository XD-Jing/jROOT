#ifndef HZZ_emuSYST_h
#define HZZ_emuSYST_h
...
class emuSYST{
    private :
        ...
        std::map<std::pair<std::string, std::string>, TH1F*> emvv_JET;
        std::map<std::pair<std::string, std::string>, TH1F*> emvv_VBF;
    ...
    public :
        emuSYST(std::string treename, std::string outfile = "out.root", std::string outopt = "update", bool THEO = false, bool SYST = false);
        virtual ~emuSYST();
        virtual void Close();
