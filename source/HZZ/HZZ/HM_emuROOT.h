#ifndef HZZ_HM_emuROOT_h
#define HZZ_HM_emuROOT_h
...
class HM_emuROOT{
    ...
    public :
        HM_emuROOT(std::string treename, std::string outfile = "out.root", std::string outopt = "update", std::string tag = "emuCR");
        virtual ~HM_emuROOT();
        virtual void Close();
