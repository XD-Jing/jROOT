#ifndef HZZ_Acceptance_jun_h
#define HZZ_Acceptance_jun_h
...
class Acceptance_jun{
    ...
    public :
        Acceptance_jun(std::string treename, std::string outfile = "out.root", std::string outopt = "update", bool THEO = false);
        virtual ~Acceptance_jun();
