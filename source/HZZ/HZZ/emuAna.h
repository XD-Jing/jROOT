...
void LM_analysis(std::string tag, std::string filename){
    ...
    TH1D* H1EEggF = GetH1(f, tag+"_ggF_EE_MET");
    TH1D* H1MMggF = GetH1(f, tag+"_ggF_MM_MET");
    TH1D* H1EMggF = GetH1(f, tag+"_ggF_EM_MET");
    TH1D* H1EE = GetH1(f, tag+"_onshell_EE");
    TH1D* H1MM = GetH1(f, tag+"_onshell_MM");
    TH2D* H2ggFE = GetH2(f, tag+"_ggF_E_PT_ETA_MET");
    TH2D* H2ggFM = GetH2(f, tag+"_ggF_M_PT_ETA_MET");
    TH2D* H2ggFEbk = (TH2D*)H2ggFE->Clone();
    TH2D* H2ggFMbk = (TH2D*)H2ggFM->Clone();
    ...
    f->cd();
    H1ggFE->Write((tag+"_ggF_ee_MET").c_str());
    H1ggFM->Write((tag+"_ggF_mm_MET").c_str());
