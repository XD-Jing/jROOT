#ifndef HZZ_Acceptance_h
#define HZZ_Acceptance_h
...
class Acceptance{
    ...
    public :
        Acceptance(std::string treename, std::string outfile = "out.root", std::string outopt = "update", bool THEO = false, bool SYST = false);
        virtual ~Acceptance();
        virtual void Close();
