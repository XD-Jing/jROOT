#ifndef HZZ_Accept_Michiel_Tree_h
#define HZZ_Accept_Michiel_Tree_h
...
class Accept_Michiel_Tree{
    ...
    public :
        Accept_Michiel_Tree(std::string treename, std::string outfile = "out.root", std::string outopt = "update", bool THEO = false);
        virtual ~Accept_Michiel_Tree();
        virtual void Close();
