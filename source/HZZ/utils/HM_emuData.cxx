...
void readROOT(){
    HM_emuROOT job("PFLOW", "HM-emuCR-Data.root", "recreate", "Data");

    std::string treeSR = "PFLOW";
    std::string treeCR = "emu_PFLOW";
    double factor = 1;

    std::string path_SR_data15 = "/eos/atlas/atlascerngroupdisk/phys-higgs/HSG2/Hllvv/Run2/minitrees_rel75/data15/Nominal/";
    std::string path_SR_data16 = "/eos/atlas/atlascerngroupdisk/phys-higgs/HSG2/Hllvv/Run2/minitrees_rel75/data16/Nominal/";
    std::string path_SR_data17 = "/eos/atlas/atlascerngroupdisk/phys-higgs/HSG2/Hllvv/Run2/minitrees_rel75/data17/Nominal/";
    std::string path_SR_data18 = "/eos/atlas/atlascerngroupdisk/phys-higgs/HSG2/Hllvv/Run2/minitrees_rel75/data18/Nominal/";
    std::string path_CR_data15 = "/eos/atlas/atlascerngroupdisk/phys-higgs/HSG2/Hllvv/Run2/minitrees_rel75/data15/Background/";
    std::string path_CR_data16 = "/eos/atlas/atlascerngroupdisk/phys-higgs/HSG2/Hllvv/Run2/minitrees_rel75/data16/Background/";
    std::string path_CR_data17 = "/eos/atlas/atlascerngroupdisk/phys-higgs/HSG2/Hllvv/Run2/minitrees_rel75/data17/Background/";
    std::string path_CR_data18 = "/eos/atlas/atlascerngroupdisk/phys-higgs/HSG2/Hllvv/Run2/minitrees_rel75/data18/Background/";
...
int main(int argc, const char *argv[]){
    readROOT();
    HM_analysis("Data", "HM-emuCR-Data.root");
    return 0;
}
