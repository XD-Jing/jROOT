...
void readROOT(std::string filename, std::string tag){
    LM_emuROOT job("PFLOW", filename,"recreate", tag);

    std::string path_SR_mc16a = "/eos/atlas/atlascerngroupdisk/phys-higgs/HSG2/Hllvv/Run2/minitrees_rel75/mc16a/Nominal/";
    std::string path_SR_mc16d = "/eos/atlas/atlascerngroupdisk/phys-higgs/HSG2/Hllvv/Run2/minitrees_rel75/mc16d/Nominal/";
    std::string path_SR_mc16e = "/eos/atlas/atlascerngroupdisk/phys-higgs/HSG2/Hllvv/Run2/minitrees_rel75/mc16e/Nominal/";
...
int main(int argc, const char *argv[]){
    readROOT("LM-emuCR-ZJets.root", "ZJets");
    readROOT("LM-emuCR-Other.root", "Other");
    readROOT("LM-emuCR-WZ.root", "WZ");
    //HM_analysis("NonRes", "emuCR-MC.root");
    return 0;
}
