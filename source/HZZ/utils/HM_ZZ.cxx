#include "HZZ/HM_ZZ.h" #include <string>
#include <iostream>
#include <TFile.h>
#include <TH1F.h>
#include <cmath>
...
void qqEWK(){
    HM_ZZ qqEWK("PFLOW", "qqEWK-rel75.root","recreate", true);
    qqEWK.LoopROOT("/eos/atlas/atlascerngroupdisk/phys-higgs/HSG2/Hllvv/Run2/minitrees_rel75/mc16a/Systematics/weightSyst/mc16_13TeV.364285.Sherpa_222_NNPDF30NNLO_llvvjj_EW6.deriv.DAOD_HIGG2D1.e6055_s3126_r9364_p3870.root", 1.5);
    qqEWK.LoopROOT("/eos/atlas/atlascerngroupdisk/phys-higgs/HSG2/Hllvv/Run2/minitrees_rel75/mc16d/Systematics/weightSyst/mc16_13TeV.364285.Sherpa_222_NNPDF30NNLO_llvvjj_EW6.deriv.DAOD_HIGG2D1.e6055_s3126_r10201_p3870.root", 1.5);
    qqEWK.LoopROOT("/eos/atlas/atlascerngroupdisk/phys-higgs/HSG2/Hllvv/Run2/minitrees_rel75/mc16e/Systematics/weightSyst/mc16_13TeV.364285.Sherpa_222_NNPDF30NNLO_llvvjj_EW6.deriv.DAOD_HIGG2D1.e6055_s3126_r10724_p3870.root", 1.5);
    qqEWK.Close();
}

void qqZZ(){
    HM_ZZ qqZZ("PFLOW", "qqZZ-rel75.root","recreate", false);
...
void ggZZ(){
    HM_ZZ ggZZ("PFLOW", "ggZZ-rel75.root","recreate", false);
