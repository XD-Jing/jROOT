...
void run(std::string folder){
    if (folder.find("PFLOW") != std::string::npos){
        ...
        std::string path_CR_mc16a = "/store/bl2/atlas/lijing/minitrees_rel75/mc16a/Systematics_Background/"+folder+"/";
        std::string path_CR_mc16d = "/store/bl2/atlas/lijing/minitrees_rel75/mc16d/Systematics_Background/"+folder+"/";
        std::string path_CR_mc16e = "/store/bl2/atlas/lijing/minitrees_rel75/mc16e/Systematics_Background/"+folder+"/";
