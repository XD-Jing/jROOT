...
void readROOT(){
    LM_emuROOT job("PFLOW", "LM-emuCR-MC-Bin4.root","recreate", "NonRes");
    //LM_emuROOT job("PFLOW", "LM-emuCR-MC.root","recreate", "NonRes");
...
int main(int argc, const char *argv[]){
    readROOT();
    LM_analysis("NonRes", "LM-emuCR-MC-Bin4.root");
    return 0;
}
