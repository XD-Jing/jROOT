...
void readROOT(std::string filename, std::string tag = "NonRes"){
    //emuROOT job("PFLOW", "emuCR-MC.root","recreate", tag);
    ...
    if (filename.find("MC16A")!=std::string::npos){
    ...
    if (filename.find("MC16D")!=std::string::npos){
    ...
    if (filename.find("MC16E")!=std::string::npos){
...
int main(int argc, const char *argv[]){
    //readROOT("emuCR-MC16A.root");
    //readROOT("emuCR-MC16D.root");
    //readROOT("emuCR-MC16E.root");
    HM_analysis("NonRes", "emuCR-MC16A.root");
    HM_analysis("NonRes", "emuCR-MC16D.root");
    HM_analysis("NonRes", "emuCR-MC16E.root");
    return 0;
}
